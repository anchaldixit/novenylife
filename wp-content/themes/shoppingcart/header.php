...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-149537289-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-149537289-1');
</script>
			...
			<div id="site-branding">
				...
				<div class="wrap">
					...
					<?php //do_action('shoppingcart_site_branding'); ?>
						...
						<img class="desktop_logo" src="https://novenylife.com/wp-content/uploads/2019/09/Noveny-logo.png">
						 </a>
					...
					<div class="main-header clearfix">
						...
						<?php $header_display = $shoppingcart_settings['shoppingcart_header_display']; ?>
							<div id="site-branding">
								...
								<div id="site-detail ad_site_logo">
									<div id="site-title">
