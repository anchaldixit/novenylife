...
function wpgs_plugin_row_meta($links) {
        ...
        $row_meta = array(
            ...
            'docs' => '<a href="' . esc_url('https://1.envato.market/3aNBr') . '" target="_blank" aria-label="' . esc_attr__('Pro Version', 'wpgs') . '" style="color:green;font-weight:600;">' . esc_html__('Pro Version', 'wpgs') . '</a>',
        );
